...
class Container_a0542683ac extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a0542683ac $container)
			{
	...
	public function createServiceContainer(): Container_a0542683ac
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'APP_KEY' => 'base64:o/qkRexMTFosfrfRHRWvwaCDS0rC5G7UPwjiZ9Dmboc=',
				'APP_LOCALE' => 'en',
				...
				'DOKU_CLIENT_ID' => '',
				'DOKU_REQUEST_TARGET' => '/orders/v1/status/INV-123',
				'DOKU_SECRET_KEY' => '',
				'FILESYSTEM_DISK' => 'local',
				'IDEMPOTENCY_LOCK_SECONDS' => '30',
				'IDEMPOTENCY_STORAGE' => 'cache',
				...
				'LOG_STACK' => 'single',
				'LS_WEBHOOK_SECRET' => '',
				'MAIL_FROM_ADDRESS' => 'noreply@tenrusl.local',
				'MAIL_FROM_NAME' => 'TenRusl Payment Webhook Sim',
				'MAIL_HOST' => '127.0.0.1',
				'MAIL_MAILER' => 'log',
				'MAIL_PASSWORD' => 'null',
				'MAIL_PORT' => '2525',
				'MAIL_SCHEME' => 'null',
				'MAIL_USERNAME' => 'null',
				'MIDTRANS_SERVER_KEY' => 'changeme',
				'MOCK_SECRET' => 'changeme',
				'OY_CALLBACK_SECRET' => '',
				'OY_IP_WHITELIST' => '',
				...
				'TENRUSL_IDEMPOTENCY_TTL' => '3600',
				'TENRUSL_IDEMPOTENCY_TTL_SECONDS' => '7200',
				'TENRUSL_MAX_RETRY_ATTEMPTS' => '5',
				'TENRUSL_RETRY_BASE_MS' => '500',
				'TENRUSL_RETRY_CAP_MS' => '30000',
				'TENRUSL_SCHEDULER_BACKOFF_MODE' => 'full',
				'TENRUSL_SCHEDULER_LIMIT' => '200',
				...
				'VITE_APP_NAME' => 'TenRusl Payment Webhook Sim',
				'WEBHOOK_DEDUP_TTL_SECONDS' => '86400',
				'windir' => 'C:\Windows',
				'XENDIT_CALLBACK_TOKEN' => 'changeme',
			],
		];
	}
