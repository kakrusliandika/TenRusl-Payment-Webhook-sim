...
class Container_9249f6c42e extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_9249f6c42e $container)
			{
	...
	public function createServiceContainer(): Container_9249f6c42e
	{
		return $this;
	}
