...
return [
    ...
    'documentations' => [
        'default' => [
            ...
            'routes' => [
                'api' => 'api/documentation', // UI di /api/documentation
            ],
            'paths' => [
                'use_absolute_path' => env('L5_SWAGGER_USE_ABSOLUTE_PATH', true),
                'swagger_ui_assets_path' => env('L5_SWAGGER_UI_ASSETS_PATH', 'vendor/swagger-api/swagger-ui/dist/'),

                // ❗ Cukup nama file, jangan pakai subfolder
                'docs_json' => 'openapi.json',
                'docs_yaml' => 'openapi.yaml',

                // Kalau ingin UI baca YAML-mu, pakai 'yaml'
                'format_to_use_for_docs' => env('L5_FORMAT_TO_USE_FOR_DOCS', 'yaml'),

                // (Scan anotasi PHP; tidak memuat YAML—biarkan saja)
                'annotations' => [
                    base_path('app'),
                    // base_path('docs'), // opsional; tidak memindai YAML
                ],
            ],
        ],
    ],
    'defaults' => [
        'routes' => [
            'docs' => 'docs', // rute file mentah (biarkan default)
